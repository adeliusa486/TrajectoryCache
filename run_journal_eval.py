...
for idx, seed in enumerate(seeds):
    ...
    # --- SIMPY ---
    lru, lfu, fifo, rand_cache, tc_caches = simpy_simulation.run_simulation(seed, NUM_CARS=600, NUM_FILES=200, CACHE_CAPACITY=20, w_sweep=w_values)
    ...
    # --- SUMO ---
    s_lru, s_lfu, s_fifo, s_rand, s_tc_caches = sumo_cache_sim.run_sumo_simulation(seed)
